class MrcnnConfig():
    def __init__(self):
        self.NAME = "coco_detector"
        self.MODEL_VERSION = "0.1.0"
        self.IMAGES_PER_GPU = 2
        self.NUM_CLASSES = 1 + 80  # Background + tags
        ...
        self.MAX_GT_INSTANCES = 0
        self.RPN_BBOX_STD_DEV = [0.1, 0.1, 0.2, 0.2]
        self.BBOX_STD_DEV = [0.1, 0.1, 0.2, 0.2]
        ...
        if self.IMAGE_RESIZE_MODE == "crop":
            self.IMAGE_SHAPE = [self.IMAGE_MIN_DIM, self.IMAGE_MIN_DIM, 3]
        else:
